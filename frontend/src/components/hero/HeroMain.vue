<template>
  <div class="isolate px-6 pt-14 lg:px-8">
    <div class="mx-auto max-w-2xl lg:pt-32">
      ...
      <div class="text-center">
        ...
        <p class="mt-6 text-lg leading-8 text-gray-400">
          Узнайте, как мы помогаем фермерам повышать эффективность, защиту и заботу о своих животных
          в новой цифровой эре скотоводства.
        </p>
